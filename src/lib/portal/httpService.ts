...
export const httpPortalService: PortalService = {
  ...
  requestPasswordReset: (email: string) =>
    call("/auth/password-reset/request", {
      method: "POST",
      body: JSON.stringify({ email }),
    }),
  resetPassword: (resetToken: string, newPassword: string) =>
    call("/auth/password-reset/confirm", {
      method: "POST",
  ...
  createMedia: (input: MediaInput) =>
    call("/admin/media", { method: "POST", body: JSON.stringify(input) }),
  ...
  createReview: (input) =>
    call("/reviews", { method: "POST", body: JSON.stringify(input) }),
  ...
  approveComment: (commentId: string) =>
    call(`/admin/comments/${commentId}/approve`, { method: "POST" }),
  unpublishComment: (commentId: string) =>
    call(`/admin/comments/${commentId}/unpublish`, { method: "POST" }),
  removeComment: (commentId: string) =>
    call(`/admin/comments/${commentId}`, { method: "DELETE" }),
  ...
  revokePurchase: (purchaseId: string) =>
    call(`/admin/payments/${purchaseId}/revoke`, { method: "POST" }),

  getPendingReviews: () => call("/admin/reviews/pending"),
  approveReview: (reviewId: string) =>
    call(`/admin/reviews/${reviewId}/approve`, { method: "POST" }),
  unpublishReview: (reviewId: string) =>
    call(`/admin/reviews/${reviewId}/unpublish`, { method: "POST" }),
  removeReview: (reviewId: string) =>
    call(`/admin/reviews/${reviewId}`, { method: "DELETE" }),
